...
`;
  ...
  useFrame((state) => {
    uniforms.time.value = 0.00005 * state.clock.getElapsedTime();
...
const App = () => {
  ...
  useTweaks('Sphere Position', {
    x: size.width <= 696 ? 14 : size.width <= 1024 ? 18 : 22,
    y: size.width <= 696 ? 10 : size.width <= 1024 ? 14 : 16,
  });
