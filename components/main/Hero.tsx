...
const Hero = () => {
    ...
    return (
        <div className='relative flex flex-col md:flex-row h-screen w-screen gap-1 z-10 align-middle overflow-hidden'>
            <motion.div
                initial="hidden"
                animate="visible"
                className="flex flex-col items-start justify-center p-4 md:ml-16 z-[20] w-full md:w-1/2"
            >
            ...
            <motion.div className="relative flex justify-center items-center w-full h-full overflow-hidden">
